...
class StoreCredit
{
    public void runFile(){
        try {
            BufferedReader reader = new BufferedReader(new FileReader("dynamicProgramming.storeCredit.in"));
            BufferedWriter writer = new BufferedWriter(new FileWriter("dynamicProgramming.storeCredit.out"));
